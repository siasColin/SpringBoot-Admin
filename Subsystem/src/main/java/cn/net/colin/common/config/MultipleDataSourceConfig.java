...
public class MultipleDataSourceConfig {
    ...
    @Bean("management")
    @ConfigurationProperties("spring.datasource.druid.management")
    ...
    @Bean
    @Primary
    public DataSource createDynamicDataSource(@Qualifier("management") DataSource management,@Qualifier("portal") DataSource portal){
        DynamicDataSource dynamicDataSource = new DynamicDataSource();
        //设置默认数据源
        dynamicDataSource.setDefaultTargetDataSource(management);
        //配置多数据源
