...
public class OrgManageController {
    ...
    public ResultInfo saveOrg(SysOrg sysOrg, HttpServletRequest request){
        ...
        try {
            ...
            lock = redisLock.lock(Constants.ORG_LOCK, 3, 30000);
        }catch (Exception e){
            e.printStackTrace();
            return resultInfo;
        }
